...
+ (void)showInViewController:(UIViewController*)viewController
         tintColor:(UIColor*)tintColor
             image:(UIImage*)image
           message:(NSString*)message
          duration:(NSTimeInterval)duration DEPRECATED_ATTRIBUTE
{
           ...
           message:(NSString *)message
{
    ...
    [CSNotificationView showInViewController:viewController
                         tintColor:[CSNotificationView blurTintColorForStyle:style]
                           ...
                           message:message
                       isShareView:(style == CSNotificationViewStyleShare)
...
-(void) setIsShareView:(BOOL)isShareView {
    _isShareView = isShareView;
    [self updateShareViews];
}
